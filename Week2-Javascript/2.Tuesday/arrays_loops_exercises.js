...
// 5. Use a for loop to print the numbers 1 to 10, but use a switch statement to print "Even" for even numbers and "Odd" for odd numbers.
// (Hint: Use the modulus operator % to check for even numbers.)

// 6. Write a while loop that starts with a number 1 and keeps doubling it until it is greater than 1000. Print each number as it doubles.
// (No conditionals needed.)

// --- Array Manipulation Exercises ---

// 7. Given the array: let colors = ["red", "green", "blue"];
// Use the push() method to add "yellow" to the end of the array. Print the array to the console.

// 8. Given the array: let numbers = [1, 2, 3, 4, 5];
// Use the pop() method to remove the last item from the array. Print the array to the console.

// 9. Given the array: let fruits = ["apple", "banana", "orange"];
// Use the shift() method to remove the first item from the array. Print the array to the console.

// 10. Given the array: let animals = ["cat", "dog", "fish"];
// Use the unshift() method to add "bird" to the beginning of the array. Print the array to the console.

// 11. Given the array: let drinks = ["water", "soda", "juice", "tea"];
// What is at index 2? Write a comment with the answer.

// 12. Given the array: let letters = ["a", "b", "c", "d", "e"];
// What happens if you try to access an element at index 10? Write a comment explaining the result.

// --- Looping Through Arrays ---

// 13. Use a for loop to print each element in the following array: let pets = ["dog", "cat", "rabbit", "hamster"];

// 14. Write a while loop to print each element in the array: let scores = [80, 90, 75, 85];
// (Hint: Use a counter variable to keep track of the current index.)

// 15. Given the array: let names = ["Alice", "Bob", "Charlie", "David"];
...
// 16. Use a for loop to print the numbers in the array: let ages = [21, 30, 25, 18, 35];
